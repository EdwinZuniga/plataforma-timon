...
export const getAsistenciaMiembros = (equipoId, id, params) => api.get(`${base(equipoId)}/${id}/asistencia-miembros`, { params })
export const saveAsistenciaMiembros = (equipoId, id, registros) => api.post(`${base(equipoId)}/${id}/asistencia-miembros`, { registros })
